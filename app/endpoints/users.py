...
from app.schemas import NewUser, UserUpdateInfo, UserResponse
...
def create_user(
    ...
    created_user = users.create_user(
        db_session=db_session, user_to_create=user_to_create
    )
...
def update_user(
    ...
    updated_user = users.update_user(
        db_session=db_session, user_update_info=user_update_info
    )
...
def delete_user(
    ...
    deleted_user = users.delete_user(
        db_session=db_session, user_id=user_to_delete.user_id
    )
