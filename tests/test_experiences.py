...
def test_update_experience(client, test_token_1, test_experience_1):
    ...
    response = client.put(
        ...
        json={"experience_id": test_experience_1["experience_id"], "rating": 4},
    )
...
def test_update_experience_unauthorized(client, test_token_2, test_experience_1):
...
def test_delete_experience_unauthorized(client, test_token_2, test_experience_1):
    client.headers = {**client.headers, "Authorization": f"Bearer {test_token_2}"}
